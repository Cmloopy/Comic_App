...
class FollowAdapter(val activity: Activity, val list: List<ComicData>): ArrayAdapter<ComicData>(activity, R.layout.item_theodoi) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val rowView = contexts.inflate(R.layout.item_theodoi,parent,false)

        val imgg = rowView.findViewById<ImageView>(R.id.anh_biaaaaaaaa)
        val tenn = rowView.findViewById<TextView>(R.id.name_comiccccccc)
